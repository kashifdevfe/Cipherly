    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          {['Hex', 'Base64', 'UPPERCASE HEX'].map((f) => (
            <button
              ...
              className={`px-3 py-1 text-[10px] font-bold rounded-md transition-all ${
                output === f ? 'bg-primary text-black' : 'text-muted-foreground hover:text-foreground'
              }`}
            >
              {f}
            </button>
        ...
        <button
          ...
          className="premium-btn w-full md:w-auto px-8 py-3 bg-primary text-black rounded-xl font-bold shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
        >
